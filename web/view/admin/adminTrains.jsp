...
<div class="container">
    ...
    <header class="clearfix">
        ...
        <h1><fmt:message key="admin.trains.title" /></h1>
    ...
    <div class="row col-md-6">
        ...
        <table class="table table-striped table-bordered table-sm" >
            ...
            <c:forEach items="${trains}" var="train">
                <tr>
                    <td><span style="color: black; ">${train.getId()}</span></td>
                    <td><span style="color: black; ">${train.getCode()}</span></td>
        ...
        <ul class="pagination">
            <c:if test="${page != 1}">
                <li class="page-item"><a class="page-link"
                                         href="adminTrains?lang=${lang}&page=${page-1}"><fmt:message key="prev" /></a>
                </li>
            </c:if>
            ...
            <c:forEach begin="1" end="${noOfPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page-item"><a class="page-link"
                                                 href="adminTrains?lang=${lang}&page=${i}">${i}</a>
                        </li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            ...
            <c:if test="${page lt noOfPages}">
                <li class="page-item"><a class="page-link"
                                         href="adminTrains?lang=${lang}&page=${page+1}"><fmt:message key="next" /></a>
                </li>
            </c:if>
        </ul>
    </nav>
