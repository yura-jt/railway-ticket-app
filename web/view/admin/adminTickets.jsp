...
<div class="container">
    ...
    <header class="clearfix">
        ...
        <h1><fmt:message key="admin.tickets.title" /></h1>
        ...
        <ul class="pagination">
            <c:if test="${page != 1}">
                <li class="page-item"><a class="page-link"
                                         href="adminTickets?lang=${lang}&page=${page-1}"><fmt:message key="prev" /></a>
                </li>
            </c:if>
            ...
            <c:forEach begin="1" end="${noOfPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <li class="page-item"><a class="page-link"
                                                 href="adminTickets?lang=${lang}&page=${i}">${i}</a>
                        </li>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
            ...
            <c:if test="${page lt noOfPages}">
                <li class="page-item"><a class="page-link"
                                         href="adminTickets?lang=${lang}&page=${page+1}"><fmt:message key="next" /></a>
                </li>
            </c:if>
        </ul>
    </nav>
