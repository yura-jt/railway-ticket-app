...
public class BillCommandTest {
    ...
    private static final String EXPECTED_VIEW = "/view/bills.jsp";
    private static final int COUNT = 13;
    private static final int PAGE_NUMBER = 2;
    private static final String STRING_PAGE = "2";
    private static final String PARAM = "PAGE";
    private static final List<Bill> TRAINS = new ArrayList<>();
    private static final String VIEW_COLLECTION_NAME = "bills";
    ...
    public void resetMocks() {
        reset(request, response, billService);
    }
    ...
    public void executeShouldReturnValidView() {
        ...
        when(billService.findAll(PAGE_NUMBER)).thenReturn(TRAINS);
        when(billService.count()).thenReturn(COUNT);

        String actual = billCommand.execute(request, response);
